...
export declare function isArray(key: any): boolean;
export declare function isObject(key: any): boolean;
export declare function isEmptyObject(obj: ObjectInterface): boolean;
